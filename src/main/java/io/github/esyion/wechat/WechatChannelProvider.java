package io.github.esyion.wechat;

import io.github.esyion.wechat.channel.*;
import io.github.esyion.wechat.config.Config;
import io.github.esyion.wechat.error.ChannelError;
import io.github.esyion.wechat.store.FileStore;
import io.github.esyion.wechat.store.Store;
import io.github.esyion.wechat.wechat.QRLogin;
import io.github.esyion.wechat.wechat.WechatApiClient;
import io.github.esyion.wechat.wechat.LoginResult;
...
/**
 * Channel handle implementation with start/stop control.
 */
    ...
    public static ChannelHandle createChannel(CreateChannelOpts opts) {
        ...
        BiConsumer<Throwable, java.util.Map<String, Object> > onError =
                opts.onError != null ? opts.onError : (e, ctx) -> {
                    System.err.println("[wechat-channel] Error: " + e);
                };
